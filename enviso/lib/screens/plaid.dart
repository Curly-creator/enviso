...
String accessToken = 'access-sandbox-dfed0c71-da80-4e2f-a83d-3e080068a668';
...
class _MyAppState extends State<PlaidScreen> {
  ...
  Future<http.Response> GetTransactions() async {
    var url = Uri.parse(
        'https://sandbox.plaid.com/transactions/get?client_id=$clientId&access_token=$accessToken&startDate=2022-01-01&endDate=2022-10-31');
